// Detect if running as Chrome Extension About page and apply styling class
if (window.location.protocol.includes('chrome-extension') && window.location.search.includes('view=about')) {
    document.documentElement.classList.add('extension-about-page');
}
